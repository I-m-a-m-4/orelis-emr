...
/**
 * Reached as `/super-admin/clinics/detail?id=<clinicId>`.
 *
 * Previously `/super-admin/clinics/[id]`. A static export has to enumerate every
 * dynamic segment at build time via `generateStaticParams`, and clinic ids are not
 * knowable then — so the id travels as a search param instead.
 */
...
/** Suspense boundary required because `useSearchParams` suspends in a static export. */
